  ...
  const projects = [
    {
      ...
      image_card: `${process.env.PUBLIC_URL}/img/superhero_1.PNG`,
      images_modal: `${process.env.PUBLIC_URL}/img/superhero_2.PNG`,
    ...
    },
    {
      ...
      image_card: `${process.env.PUBLIC_URL}/img/time-series_1.png`,
      images_modal:`${process.env.PUBLIC_URL}/img/time-series_2.png`,
    ...
    },
    {
      ...
      image_card: `${process.env.PUBLIC_URL}/img/co2_1.png`,
      images_modal:`${process.env.PUBLIC_URL}/img/co2_1.png`,
    ...
    },
    {
      ...
      image_card: `${process.env.PUBLIC_URL}/img/churn_01.png`,
      images_modal:`${process.env.PUBLIC_URL}/img/churn_02.png`,
    ...
    },
    {
      ...
      image_card: `${process.env.PUBLIC_URL}/img/blog_01.PNG`,
      images_modal:`${process.env.PUBLIC_URL}/img/blog_02.PNG`,
    ...
    },
    {
      ...
      image_card: `${process.env.PUBLIC_URL}/img/crawler_01.PNG`,
      images_modal:`${process.env.PUBLIC_URL}/img/crawler_02.PNG`,
